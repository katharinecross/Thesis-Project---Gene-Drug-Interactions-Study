...
library(superheat)
data1 = read.csv("/Users/tingtingzhao/Documents/data/rubicinAndOther/vorinostat/subGeneMtx01.csv", header=FALSE)
data2 = read.csv("/Users/tingtingzhao/Documents/data/rubicinAndOther/trichostatin-a/subGeneMtx01.csv", header=FALSE)
data3 = read.csv("/Users/tingtingzhao/Documents/data/rubicinAndOther/wortmannin/subGeneMtx01.csv", header=FALSE)
data4 = read.csv("/Users/tingtingzhao/Documents/data/rubicinAndOther/geldanamycin/subGeneMtx01.csv", header=FALSE)
data5 = read.csv("/Users/tingtingzhao/Documents/data/rubicinAndOther/sirolimus/subGeneMtx01.csv", header=FALSE)

levels1 = c('Vorinostat','DMSO')
levels2 = c('Trichostatin-a', 'DMSO')
levels3 = c('Wortmannin', 'DMSO')
levels4 = c('Geldanamycin', 'DMSO')
levels5 = c('Sirolimus', 'DMSO')

cluster1 =  factor(c(rep('Vorinostat',(dim(data1)[1]/2)), rep('DMSO', (dim(data1)[1]/2))),levels=levels1)
cluster2 =  factor(c(rep('Trichostatin-a',(dim(data2)[1]/2)), rep('DMSO', (dim(data2)[1]/2))), levels=levels2)
cluster3 =  factor(c(rep('Wortmannin',(dim(data3)[1]/2)), rep('DMSO', (dim(data3)[1]/2))), levels=levels3)
cluster4 =  factor(c(rep('Geldanamycin',(dim(data4)[1]/2)), rep('DMSO', (dim(data4)[1]/2))), levels=levels4)
cluster5 =  factor(c(rep('Sirolimus',(dim(data5)[1]/2)), rep('DMSO', (dim(data5)[1]/2))), levels=levels5)
...
varNames1 = read.csv("/Users/tingtingzhao/Documents/data/rubicinAndOther/vorinostat/allSelectedGenes01.csv", header=TRUE)
geneNames1 = varNames['pr_gene_symbol']
names(data1) = unlist(geneNames1)

Ykmean1 = read.csv("/Users/tingtingzhao/Documents/data/rubicinAndOther/vorinostat/KnockoffAverage.csv", header=FALSE)
Ykselected1 = Ykmean1[, varNames1[,1]]
names(Ykselected1) = unlist(geneNames1)
png("/Users/tingtingzhao/Documents/data/rubicinAndOther/vorinostat/superheatFDR01Knockoff.png", height = 900, width = 900)
...
#-----
png("/Users/tingtingzhao/Documents/data/rubicinAndOther/vorinostat/superheatFDR01Full.png", height = 900, width = 900)
superheat(data1,
          # normalize variables
          scale = F,
          # order rows/cols based on heirarchical clustering
